...
public class MahoutKaggleDigitRecognizerTest {
	private static DecisionForest buildForest(int numberOfTrees, Data data) {
		int m = (int) Math
				.floor(MathUtils.log(2, data.getDataset().nbAttributes()) + 1);
	...
	public static void main(String[] args) throws Exception {
		...
		String[] trainDataValues = testFileAsStringArray("data/train.csv");
